...
var defaults = {
  ...
  kanbanGO: {
    inputECDSA : {
      messageECDSA: "inputKBGOECDSAMessage",
      messageECDSAHex: "inputKBGOECDSAMessageHex",
      privateKeyECDSA: "inputKBGOECDSAPrivateKey",
      publicKeyECDSA: "inputKBGOECDSAPublicKey",
    },
    inputSchnorr: {
